...
//
// Proves three things without revealing the fingerprints:
...
component main {public [commitment_new, commitment_prev, threshold]} = IAMHamming(256);
